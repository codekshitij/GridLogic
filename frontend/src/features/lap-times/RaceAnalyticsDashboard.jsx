    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      {visible.has("strategy") && (
        <section style={sectionStyle}>
          ...
          <div
            style={{ marginTop: "0.7rem", maxHeight: 160, overflow: "auto" }}
          >
      ...
      {visible.has("comparisons") && (
        <section style={sectionStyle}>
          ...
          <div
            style={{ marginTop: "0.45rem", maxHeight: 210, overflow: "auto" }}
          >
            <table style={tableStyle}>
              <thead>
                <tr>
          ...
          >
            {visible.has("race-control") ? (
              <div>
                ...
                >
                  Interactive map/video sync: unavailable in current public
                  timing feed. Timeline still highlights major race-control
                  events.
                </div>
                <div
                  style={{
            ...
            {visible.has("setup") ? (
              <div>
                ...
                >
                  ...
                  unavailable to avoid inventing non-existent telemetry
                  channels.
                </div>
              </div>
            ) : (
